...
class Routes extends React.Component {
    ...
    async selectBoarding(e) {
        ...
        const result = await axios(process.env.REACT_APP_API_URL + '/bus/routes/' + this.state.route + '/directions/' + this.state.direction + '/boarding/' + value.platecode + '/alighting');
        this.setState({
                                            ...
                                            <Select
                                                ...
                                                {this.state.boardingStops.map(boarding => (
                                                    <MenuItem key={boarding.id}
                                                              value={boarding}>{boarding.shortcommonname_en + " Bus Stop: " + boarding.platecode}</MenuItem>
                                                ))}
                                            </Select>
                                        </FormControl>
                                    </div>
                                            ...
                                            <Select
                                                ...
                                                {this.state.alightingStops.map(alighting => (
                                                    <MenuItem key={alighting.id}
                                                              value={alighting}>{alighting.shortcommonname_en + " Bus Stop: " + alighting.platecode}</MenuItem>
                                                ))}
                                            </Select>
                                        </FormControl>
                                    </div>
